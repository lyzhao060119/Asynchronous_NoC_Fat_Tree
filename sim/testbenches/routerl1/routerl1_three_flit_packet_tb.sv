...
module routerl1_three_flit_packet_tb;
  ...
  task automatic send_parent0(input logic [21:0] flit);
    begin
      io_inputs_parent_0_Data_flit = flit;
      #1;
      io_inputs_parent_0_HS_Req = ~io_inputs_parent_0_HS_Req;
      $display("[%0t ns] inject parent0 flit=0x%06h req=%0b", $realtime, flit, io_inputs_parent_0_HS_Req);
      wait (io_inputs_parent_0_HS_Ack === io_inputs_parent_0_HS_Req);
      $display("[%0t ns] parent0 ack  =0x%06h ack=%0b", $realtime, flit, io_inputs_parent_0_HS_Ack);
      #1;
    end
  endtask
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_child_0_0_HS_Req !== 1'bx) &&
        ...
        $display("[%0t ns] child0 recv #%0d flit=0x%06h", $realtime, child_count_0, io_outputs_child_0_0_Data_flit);
        #2;
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_child_1_0_HS_Req !== 1'bx) &&
        ...
        $display("[%0t ns] child1 recv #%0d flit=0x%06h", $realtime, child_count_1, io_outputs_child_1_0_Data_flit);
        #4;
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_child_2_0_HS_Req !== 1'bx) &&
        ...
        $display("[%0t ns] child2 recv #%0d flit=0x%06h", $realtime, child_count_2, io_outputs_child_2_0_Data_flit);
        #6;
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_child_3_0_HS_Req !== 1'bx) &&
        ...
        $display("[%0t ns] child3 recv #%0d flit=0x%06h", $realtime, child_count_3, io_outputs_child_3_0_Data_flit);
        #8;
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_parent_0_HS_Req !== 1'bx) &&
        ...
        $fatal(1, "[%0t ns] unexpected parent0 output flit=0x%06h", $realtime, io_outputs_parent_0_Data_flit);
      end
    end
  end
  ...
  initial begin
    ...
    forever begin
      ...
      if ((io_outputs_parent_1_HS_Req !== 1'bx) &&
        ...
        $fatal(1, "[%0t ns] unexpected parent1 output flit=0x%06h", $realtime, io_outputs_parent_1_Data_flit);
      end
    end
  end
endmodule
